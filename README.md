...
Someone in Foundation hates versioning, so now it is impossible to distinguish
release (let's call it 6.0) from bug-fixes version (6.x). Guess, next step will
be to abandon versions at all.
